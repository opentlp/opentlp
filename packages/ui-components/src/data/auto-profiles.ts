...
export const AUTO_APP_PROFILES: PrinterModelProfile[] = [
    ...
    },
    {
        ...
        kind: 'label',
        supportedTransports: ['bluetooth-le', 'bluetooth-classic', 'usb-serial'],
        capabilities: { canvasHeightPx: 96, maxDensity: 15, supportsSpeedMode: false, colorSupport: { type: 'monochrome' }, dpmm: 8, driverId: 'marklife-0x1f', driverName: 'Marklife-0x1F' },
    ...
    },
    {
        ...
        kind: 'label',
        supportedTransports: ['bluetooth-le', 'bluetooth-classic', 'usb-serial'],
        capabilities: { canvasHeightPx: 96, maxDensity: 3, supportsSpeedMode: false, colorSupport: { type: 'monochrome' }, dpmm: 8, driverId: 'niimbot', driverName: 'Niimbot Generic Printer' },
    ...
    },
    {
        ...
        kind: 'pocket',
        supportedTransports: ['bluetooth-le'],
        capabilities: { canvasHeightPx: 384, maxDensity: 1, supportsSpeedMode: false, colorSupport: { type: 'monochrome' }, dpmm: 8, driverId: 'catprinter-mxw01', driverName: 'Catprinter (V5X/MXW01 bulk raster)' },
    ...
    },
    {
        ...
        kind: 'pocket',
        supportedTransports: ['bluetooth-le'],
        capabilities: { canvasHeightPx: 384, maxDensity: 1, supportsSpeedMode: false, colorSupport: { type: 'monochrome' }, dpmm: 8, driverId: 'catprinter-funny-lx', driverName: 'Funny Print (LX-D / BH-01 direct raster)' },
    ...
    },
    {
        ...
        capabilities: { canvasHeightPx: 384, maxDensity: 8, supportsSpeedMode: false, colorSupport: { type: 'monochrome' }, dpmm: 8, driverId: 'phomemo-m02', driverName: 'Phomemo M02 family' },
    ...
    },
    {
        ...
        kind: 'label',
        supportedTransports: ['bluetooth-le', 'bluetooth-classic', 'usb-serial', 'usb'],
        capabilities: { canvasHeightPx: 384, maxDensity: 8, supportsSpeedMode: false, colorSupport: { type: 'monochrome' }, dpmm: 8, driverId: 'phomemo-m110', driverName: 'Phomemo M110/M120/M220' },
    ...
    },
    {
        ...
        kind: 'pocket',
        supportedTransports: ['bluetooth-le', 'bluetooth-classic', 'usb-serial', 'usb'],
        capabilities: { canvasHeightPx: 384, maxDensity: 1, supportsSpeedMode: false, colorSupport: { type: 'monochrome' }, dpmm: 8, driverId: 'peripage', driverName: 'PeriPage raw GS v 0' },
