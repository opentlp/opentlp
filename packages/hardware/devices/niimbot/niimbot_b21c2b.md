...
print:
  ...
  width_mm: 48
  dpi: 203
  media: [gap, continuous, transparent, black-mark]
  colour: monochrome
  colour_planes: 1
  max_density: 5
...
The advertised Bluetooth name. `B21_C2B` is how a driver's table spells it,
which is not necessarily what the printer broadcasts.
