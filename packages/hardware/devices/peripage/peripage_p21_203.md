...
brand: PeriPage
model: P21 (203 dpi)
summary: 384-dot standard-resolution P21 profile; excludes the compressed P21+.
...
sources:
  ...
  - kind: vendor-doc
    ...
    retrieved: 2026-09-12
    note: App 6.10.11 clean-room inspection maps PPG_P21_SD to the 384-dot, 8-dpmm raw path and density range 0-2, while routing P21+ through compression.
  - kind: vendor-doc
...
The resolution-qualified firmware name is required for automatic profile
selection. `P21` alone is ambiguous, and `P21+` is a different compressed path.
